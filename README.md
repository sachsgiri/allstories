...
1. **Create the repo**
   ...
   - Click **Create repository**. Leave it empty (no README, no license) —
     you'll upload the files directly.
...
- **GitHub Pro or Team** ($4–$9/user/month): lets you make the repo private
  while still serving it via Pages, restricted to invited collaborators
  (their GitHub accounts, not a password).
